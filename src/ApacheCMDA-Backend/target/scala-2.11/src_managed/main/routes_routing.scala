// @SOURCE:/home/SOC-Fall-2015/Dev/SOC-Fall-2015-Team1/ApacheCMDA-Backend/conf/routes
// @HASH:bdacd3d1f2505235b5566a81722a06ba82127bc6
// @DATE:Thu Dec 17 21:26:19 UTC 2015
...
// @LINE:23
private[this] lazy val controllers_ClimateServiceController_getClimateServiceByKeyWord13_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("climateService/getClimateServiceByKeyWord/key/"),DynamicPart("key", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_ClimateServiceController_getClimateServiceByKeyWord13_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ClimateServiceController]).getClimateServiceByKeyWord(fakeValue[String], fakeValue[String]),
HandlerDef(this.getClass.getClassLoader, "", "controllers.ClimateServiceController", "getClimateServiceByKeyWord", Seq(classOf[String], classOf[String]),"GET", """""", Routes.prefix + """climateService/getClimateServiceByKeyWord/key/$key<[^/]+>/json"""))
...
// @LINE:56
private[this] lazy val controllers_UserController_getAllUserNames37_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/getAllUserNames"))))
private[this] lazy val controllers_UserController_getAllUserNames37_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).getAllUserNames(fakeValue[String]),
HandlerDef(this.getClass.getClassLoader, "", "controllers.UserController", "getAllUserNames", Seq(classOf[String]),"GET", """""", Routes.prefix + """users/getAllUserNames"""))
...
// @LINE:64
private[this] lazy val controllers_CommentController_addComment41_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("comment/addComment"))))
...
HandlerDef(this.getClass.getClassLoader, "", "controllers.CommentController", "addComment", Nil,"POST", """ Comment""", Routes.prefix + """comment/addComment"""))
        

// @LINE:65
private[this] lazy val controllers_CommentController_getCommentsByServiceID42_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("comment/getCommentByServiceID/serviceID/"),DynamicPart("serviceID", """[^/]+""",true))))
private[this] lazy val controllers_CommentController_getCommentsByServiceID42_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.CommentController]).getCommentsByServiceID(fakeValue[String]),
HandlerDef(this.getClass.getClassLoader, "", "controllers.CommentController", "getCommentsByServiceID", Seq(classOf[String]),"GET", """""", Routes.prefix + """comment/getCommentByServiceID/serviceID/$serviceID<[^/]+>"""))
...
// @LINE:23
case controllers_ClimateServiceController_getClimateServiceByKeyWord13_route(params) => {
   call(params.fromPath[String]("key", None), Param[String]("format", Right("json"))) { (key, format) =>
        controllers_ClimateServiceController_getClimateServiceByKeyWord13_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ClimateServiceController]).getClimateServiceByKeyWord(key, format))
   }
}
...
// @LINE:56
case controllers_UserController_getAllUserNames37_route(params) => {
   call(Param[String]("format", Right("json"))) { (format) =>
        controllers_UserController_getAllUserNames37_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).getAllUserNames(format))
   }
}
...
// @LINE:65
case controllers_CommentController_getCommentsByServiceID42_route(params) => {
   call(params.fromPath[String]("serviceID", None)) { (serviceID) =>
        controllers_CommentController_getCommentsByServiceID42_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.CommentController]).getCommentsByServiceID(serviceID))
   }
}
...
// @LINE:71
case controllers_ServiceGradeController_addGrade44_route(params) => {
   call { 
        controllers_ServiceGradeController_addGrade44_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ServiceGradeController]).addGrade)
   }
}
        

// @LINE:74
case controllers_ServiceLikeController_likeServices45_route(params) => {
   call(Param[String]("format", Right("json"))) { (format) =>
        controllers_ServiceLikeController_likeServices45_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ServiceLikeController]).likeServices(format))
   }
}
        

// @LINE:75
case controllers_ServiceLikeController_isLike46_route(params) => {
   call(Param[String]("format", Right("json"))) { (format) =>
        controllers_ServiceLikeController_isLike46_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ServiceLikeController]).isLike(format))
   }
}
        

// @LINE:76
case controllers_ServiceLikeController_getRecommendServices47_route(params) => {
   call(Param[String]("format", Right("json"))) { (format) =>
        controllers_ServiceLikeController_getRecommendServices47_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ServiceLikeController]).getRecommendServices(format))
   }
}
