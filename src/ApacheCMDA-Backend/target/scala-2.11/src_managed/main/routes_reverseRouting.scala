...
// @LINE:71
class ReverseServiceGradeController {


// @LINE:71
def addGrade(): Call = {
   import ReverseRouteContext.empty
   Call("POST", _prefix + { _defaultPrefix } + "serviceGrade/addGrade")
}
...
// @LINE:56
def getAllUserNames(): Call = {
   implicit val _rrc = new ReverseRouteContext(Map(("format", "json")))
   Call("GET", _prefix + { _defaultPrefix } + "users/getAllUserNames")
}
...
// @LINE:75
// @LINE:74
class ReverseServiceLikeController {


// @LINE:75
def isLike(): Call = {
   implicit val _rrc = new ReverseRouteContext(Map(("format", "json")))
   Call("POST", _prefix + { _defaultPrefix } + "serviceLike/status")
}
                        

// @LINE:76
def getRecommendServices(): Call = {
   implicit val _rrc = new ReverseRouteContext(Map(("format", "json")))
   Call("POST", _prefix + { _defaultPrefix } + "serviceLike/recommendServices")
}
                        

// @LINE:74
def likeServices(): Call = {
   implicit val _rrc = new ReverseRouteContext(Map(("format", "json")))
   Call("POST", _prefix + { _defaultPrefix } + "serviceLike/likeService")
}
...
// @LINE:65
def getCommentsByServiceID(serviceID:String): Call = {
   import ReverseRouteContext.empty
   Call("GET", _prefix + { _defaultPrefix } + "comment/getCommentByServiceID/serviceID/" + implicitly[PathBindable[String]].unbind("serviceID", dynamicString(serviceID)))
}
...
def addComment(): Call = {
   import ReverseRouteContext.empty
   Call("POST", _prefix + { _defaultPrefix } + "comment/addComment")
}
...
// @LINE:23
def getClimateServiceByKeyWord(key:String): Call = {
   implicit val _rrc = new ReverseRouteContext(Map(("format", "json")))
   Call("GET", _prefix + { _defaultPrefix } + "climateService/getClimateServiceByKeyWord/key/" + implicitly[PathBindable[String]].unbind("key", dynamicString(key)) + "/json")
}
...
def addGrade : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.ServiceGradeController.addGrade",
   """
      function() {
      return _wA({method:"POST", url:"""" + _prefix + { _defaultPrefix } + """" + "serviceGrade/addGrade"})
      }
   """
)
...
// @LINE:56
def getAllUserNames : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.UserController.getAllUserNames",
   """
      function() {
      return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "users/getAllUserNames"})
      }
   """
)
...
// @LINE:75
def isLike : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.ServiceLikeController.isLike",
   """
      function() {
      return _wA({method:"POST", url:"""" + _prefix + { _defaultPrefix } + """" + "serviceLike/status"})
      }
   """
)
...
// @LINE:76
def getRecommendServices : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.ServiceLikeController.getRecommendServices",
   """
      function() {
      return _wA({method:"POST", url:"""" + _prefix + { _defaultPrefix } + """" + "serviceLike/recommendServices"})
      }
   """
)
...
// @LINE:74
def likeServices : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.ServiceLikeController.likeServices",
   """
      function() {
      return _wA({method:"POST", url:"""" + _prefix + { _defaultPrefix } + """" + "serviceLike/likeService"})
      }
   """
)
...
// @LINE:65
def getCommentsByServiceID : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.CommentController.getCommentsByServiceID",
   """
      function(serviceID) {
      return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "comment/getCommentByServiceID/serviceID/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("serviceID", encodeURIComponent(serviceID))})
      }
   """
)
...
def addComment : JavascriptReverseRoute = JavascriptReverseRoute(
   ...
   """
      function() {
      return _wA({method:"POST", url:"""" + _prefix + { _defaultPrefix } + """" + "comment/addComment"})
      }
   """
)
...
// @LINE:23
def getClimateServiceByKeyWord : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.ClimateServiceController.getClimateServiceByKeyWord",
   """
      function(key) {
      return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "climateService/getClimateServiceByKeyWord/key/" + (""" + implicitly[PathBindable[String]].javascriptUnbind + """)("key", encodeURIComponent(key)) + "/json"})
      }
   """
)
...
// @LINE:71
def addGrade(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ServiceGradeController]).addGrade(), HandlerDef(this.getClass.getClassLoader, "", "controllers.ServiceGradeController", "addGrade", Seq(), "POST", """ Service Grade""", _prefix + """serviceGrade/addGrade""")
)
...
// @LINE:56
def getAllUserNames(format:String): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).getAllUserNames(format), HandlerDef(this.getClass.getClassLoader, "", "controllers.UserController", "getAllUserNames", Seq(classOf[String]), "GET", """""", _prefix + """users/getAllUserNames""")
)
...
// @LINE:75
def isLike(format:String): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ServiceLikeController]).isLike(format), HandlerDef(this.getClass.getClassLoader, "", "controllers.ServiceLikeController", "isLike", Seq(classOf[String]), "POST", """""", _prefix + """serviceLike/status""")
)
                      

// @LINE:76
def getRecommendServices(format:String): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ServiceLikeController]).getRecommendServices(format), HandlerDef(this.getClass.getClassLoader, "", "controllers.ServiceLikeController", "getRecommendServices", Seq(classOf[String]), "POST", """""", _prefix + """serviceLike/recommendServices""")
)
                      

// @LINE:74
def likeServices(format:String): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ServiceLikeController]).likeServices(format), HandlerDef(this.getClass.getClassLoader, "", "controllers.ServiceLikeController", "likeServices", Seq(classOf[String]), "POST", """ Service Grade""", _prefix + """serviceLike/likeService""")
)
...
// @LINE:65
def getCommentsByServiceID(serviceID:String): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.CommentController]).getCommentsByServiceID(serviceID), HandlerDef(this.getClass.getClassLoader, "", "controllers.CommentController", "getCommentsByServiceID", Seq(classOf[String]), "GET", """""", _prefix + """comment/getCommentByServiceID/serviceID/$serviceID<[^/]+>""")
)
                      

// @LINE:64
def addComment(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.CommentController]).addComment(), HandlerDef(this.getClass.getClassLoader, "", "controllers.CommentController", "addComment", Seq(), "POST", """ Comment""", _prefix + """comment/addComment""")
)
...
// @LINE:23
def getClimateServiceByKeyWord(key:String, format:String): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ClimateServiceController]).getClimateServiceByKeyWord(key, format), HandlerDef(this.getClass.getClassLoader, "", "controllers.ClimateServiceController", "getClimateServiceByKeyWord", Seq(classOf[String], classOf[String]), "GET", """""", _prefix + """climateService/getClimateServiceByKeyWord/key/$key<[^/]+>/json""")
)
